...
export default function (eleventyConfig) {
  ...
  eleventyConfig.addFilter("videoEmbedUrl", videoEmbedUrl);
  eleventyConfig.addFilter("videoAspectRatio", videoAspectRatio);
  ...
  eleventyConfig.addFilter("socialIcon", function (platform) {
    ...
    return (
      icons[p] ||
      `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true"><circle cx="12" cy="12" r="10"/></svg>`
    );
  });
